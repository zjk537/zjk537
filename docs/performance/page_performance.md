---
home: false
title: FP、FCP、FMP、LCP都是什么?
date: 2023-05-17
# sidebar: 'auto'
subSidebar: false
permalink: /pages/e93fa3/
categories:
 - performance
tags:
 - page performance
...
前端性能监控相关指标，你知道FP、FCP、FMP、LCP代表什么事件吗？它们的先后顺序如何呢？如何计算？前端性能监控中常用哪些指标？
...
2020年，谷歌将Core Web Vitals新纳入的用户体验指标。其中核心的3个就是LCP、FID、CLS。后面会详细说明。
...
```
## 4. 稳定性指标 CLS
CLS（[Cumulative Layout Shift](https://web.dev/cls/)）是对在页面的整个生命周期中发生的每一次意外布局变化的最大布局变化得分的度量，布局变化得分越小证明你的页面越稳定。
